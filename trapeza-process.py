...
def main():
    parser = argparse.ArgumentParser(description="Manipulate and combine tabular data files. Use this utility to process a master data set for use with trapeza-match.")
